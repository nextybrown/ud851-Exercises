...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
         partySize = Integer.parseInt(mNewPartySizeEditText.getText().toString());
           ...
           Log.e(LOG_TAG," Integer parse  error ") ;
        }
         String guessName= mNewGuestNameEditText.getText().toString();
    ...
    public long addGuess(String  valueName , int partySize){
        ContentValues contentValues = new ContentValues();
        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME,valueName);
