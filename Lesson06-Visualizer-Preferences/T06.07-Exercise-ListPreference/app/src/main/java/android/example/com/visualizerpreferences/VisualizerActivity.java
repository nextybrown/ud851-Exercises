...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_color_option_key),
                getResources().getString(R.string.pref_color_blue_value)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        }else if( key.equals(getString(R.string.pref_color_option_key))){

            mVisualizerView.setColor(sharedPreferences.getString(key, getResources().getString(R.string.pref_color_blue_value)));
        }
    }
