...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId==R.id.action_search){
            Toast.makeText(getApplicationContext(),"Seach Menu Seleted",Toast.LENGTH_SHORT).show();
            return true;
    ...
    // COMPLETED (13) If the item's ID is R.id.c, show a Toast and return true to tell Android that you've handled this menu click
