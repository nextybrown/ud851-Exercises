...
public class MainActivity extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<String>{
   ...
   // private static final String SEARCH_RESULTS_RAW_JSON = "results";
    ...
    private static  final int  GITHUB_SEARCH_LOADER = 55;
    ...
    private void makeGithubSearchQuery() {
       ...
       // new GithubQueryTask().execute(githubSearchUrl);
        ...
        Bundle queryBundle = new Bundle();
            ...
            Loader<Object> loader = supportLoaderManager.getLoader(GITHUB_SEARCH_LOADER);
                ...
                public Loader<String> onCreateLoader(int id, final Bundle args) {
                    return  new AsyncTaskLoader<String>(this){
                        ...
                        public String loadInBackground() {
                            String argsString= args.getString(SEARCH_QUERY_URL_EXTRA);
                            if (args.isEmpty() || (argsString == null)) {
                                return null;
                            }

                            try {
                                URL gitUrl  = new URL(argsString);
