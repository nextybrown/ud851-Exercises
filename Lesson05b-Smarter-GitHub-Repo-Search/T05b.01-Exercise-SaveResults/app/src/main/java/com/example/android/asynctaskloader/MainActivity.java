...
public class MainActivity extends AppCompatActivity {
    ...
    private  static  final  String  SEARCH_JON="SEARCH_JON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState!= null){
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_JON));
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String s1 = mUrlDisplayTextView.getText().toString();
        String s2 = mSearchResultsTextView.getText().toString();

         outState.putString(QUERY_URL,s1);
         outState.putString(SEARCH_JON,s2);
